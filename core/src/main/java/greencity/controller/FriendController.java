...
public class FriendController {
    ...
    @Operation(
            ...
            description = "Removes the friendship connection between current user and friend with given friendId"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> removeFriend(@PathVariable Long friendId, @Parameter(hidden = true) @CurrentUser UserVO userVO) {
